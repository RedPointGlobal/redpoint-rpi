...
**When to skip:** If using the `sdk` or `csi` secrets provider, secrets come from your cloud vault. The CLI will display the required vault key names instead of prompting for values.
