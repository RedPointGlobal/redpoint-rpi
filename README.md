...
| **Values.yaml** | Generate with the [Interaction CLI](docs/greenfield.md#2-quick-start-with-the-interaction-cli) | Re-run the [Interaction CLI](docs/greenfield.md#2-quick-start-with-the-interaction-cli) with your existing values, then `--add` features as needed |
