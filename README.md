...
global:
  replicaCount: 3
``` 
NOTE: Only the ```Integration API``` service does not support HA as of this release so you should only run a single replica to avoid any weird error and behaviour. This should be resolved in a future release 
