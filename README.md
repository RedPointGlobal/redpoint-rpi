...
| **Warehouses** | AzureSQLDatabase, AmazonRDSSQL, GoogleCloudSQL, SQLServer, Snowflake, PostgreSQL, Amazon Redshift, Google BigQuery |
...
> **Important:** Never edit files under `chart/`. All customization goes in your overrides file, generated by the [Interaction CLI](docs/greenfield.md#2-quick-start-with-the-interaction-cli). Use the `advanced:` block to override any internal default without forking the chart.
